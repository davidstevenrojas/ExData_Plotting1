...
##Plot #4
##Set 2 x 2 spots for 4 plots, adjusting margins as needed
par(mfrow=c(2,2), mar=c(4.1,4.1,1.9,1.3), oma=c(0,0,2,0))
plot(tmp$Global_active_power ~ tmp$Datetime,type = "l",ylab = "Global Active Power", xlab = "")
plot(tmp$Voltage ~ tmp$Datetime,type = "l",ylab = "Voltage", xlab = "datetime")
with(tmp, {
...
plot(tmp$Global_reactive_power ~ tmp$Datetime,type = "l",ylab = "Global_reactive_power", xlab = "datetime")
